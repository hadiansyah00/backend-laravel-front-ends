<footer class="text-white">
    ...
    <div class="bg-orange-600">
        <div class="container px-6 py-8 mx-auto">
            @php
            $partners = [
            ['logo' => asset('assets/img/icon/logo_putih_sbh.png'), 'alt' => 'Sekolah Tinggi Ilmu Kesehatan Bogor
            Husada'],
            ['logo' => asset('assets/img/icon/logo_putih_diktisaintek.webp'), 'alt' => 'DIKTISAINTEK BERDAMPAK'],
            ['logo' => asset('assets/img/icon/rs-azra.png'), 'alt' => 'Transformation Towards the Ultimate'],
            ['logo' => asset('assets/img/icon/sdg-bw.webp'), 'alt' => 'Sustainable Development Goals'],
            ];
            @endphp
    ...
    {{-- ============================================= --}}
    <div class="bg-gradient-to-r from-orange-500 to-orange-700">
        <div class="container px-6 py-12 mx-auto">
            ...
            <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                    ...
                    <div class="mt-4 space-y-2 text-sm">
                        <a href="tel:{{ setting('contact_phone_link', '#') }}"
                            class="flex items-center gap-2 text-orange-200 transition-colors duration-300 hover:text-white">
                ...
                <div>
                    ...
                    <ul class="mt-4 space-y-2 text-sm">
                        ...
                        <li>
                            <a href="{{ $link['url'] ?? '#' }}"
                                class="text-orange-200 transition-colors duration-300 hover:text-white">
                                {{ $link['text'] ?? 'Link' }}
                            </a>
                        </li>
                        @endforeach
            ...
            {{-- Garis Pemisah --}}
            <hr class="my-10 border-orange-500">

            {{-- Baris Copyright & Socials --}}
            <div class="flex flex-col items-center sm:flex-row sm:justify-between">
                <p class="text-sm text-orange-200">{{ setting('copyright_text', '© Copyright ' . date('Y') . '. All
                    Rights Reserved.') }}</p>
                ...
                <div class="flex items-center mt-4 -mx-2 sm:mt-0">
                    ...
                    <a href="{{ $social['url'] ?? '#' }}"
                        class="px-2 text-orange-200 transition-colors duration-300 hover:text-white"
