...
<div class="space-y-6">
    ...
    <div>
        ...
        <textarea name="content" id="content" rows="10"
            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 font-mono dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('content', isset($section) ? (is_array($section->content) ? json_encode($section->content, JSON_PRETTY_PRINT) :
