...
<div class="mb-6 bg-white rounded-lg shadow-sm dark:bg-gray-800">
    <div class="p-4 border-b border-gray-200 dark:border-gray-700 sm:p-6">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold leading-none text-gray-900 dark:text-white">Tambah Data Alumni</h3>
    ...
    <div class="p-4 sm:p-6">
        ...
        <form action="{{ route('admin.alumnis.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-6 flex justify-end gap-3">
                ...
                <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700">Simpan Alumni</button>
            </div>
        </form>
    </div>
</div>
