...
<div class="mb-6 bg-white rounded-lg shadow-sm dark:bg-gray-800">
    <div class="p-4 border-b border-gray-200 dark:border-gray-700 sm:p-6">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold leading-none text-gray-900 dark:text-white">Tambah Data Program Studi</h3>
    ...
    <div class="p-4 sm:p-6">
        ...
        <form action="{{ route('admin.program-studis.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
