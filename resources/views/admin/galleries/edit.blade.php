...
<div class="mb-6 bg-white rounded-lg shadow-sm dark:bg-gray-800">
    <div class="p-4 border-b border-gray-200 dark:border-gray-700 sm:p-6">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold leading-none text-gray-900 dark:text-white">Edit Foto: {{ Str::limit($gallery->title, 40) }}</h3>
            <a href="{{ route('admin.galleries.index') }}" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500">
                &larr; Batal & Kembali
            </a>
        </div>
    </div>
