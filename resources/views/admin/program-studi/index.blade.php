<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.programstudi.create') }}"
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">{{ Str::limit($program->description, 60) }}</td>
                            <td class="px-6 py-4">
                                @if ($program->link)
                                <a href="{{ $program->link }}" target="_blank"
                                    class="text-blue-500 hover:underline">Kunjungi</a>
                                @else
                                <span class="text-gray-400">-</span>
                                @endif
                            </td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end space-x-1">
                                    ...
                                    {{-- Edit --}}
                                    <a href="{{ route('admin.programstudi.edit', $program->id) }}"
                                    ...
                                    {{-- Delete --}}
                                    <form action="{{ route('admin.programstudi.destroy', $program->id) }}" method="POST"
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <td colspan="5" class="px-6 py-4 text-center">Belum ada program.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
