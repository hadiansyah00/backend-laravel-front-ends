                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <td class="px-6 py-4">{{ $t->slug }}</td>
                            <td class="px-6 py-4 text-right">
                                <div class="flex items-center justify-end space-x-2">
                                    <a href="{{ route('admin.tags.edit', $t) }}"
                                    ...
                                    <form action="{{ route('admin.tags.destroy', $t) }}" method="POST"
                                        onsubmit="return confirm('Yakin ingin menghapus Tags ini?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                        ...
                        @empty
                        <tr>
                            <td colspan="3" class="px-6 py-4 text-center">Tidak ada tag ditemukan.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
