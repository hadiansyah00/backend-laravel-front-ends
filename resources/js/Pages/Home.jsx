...
export default function Home({ berita, programStudis, beranda = {}, pengumuman = [], events = [], galleries = [], alumnis = [], kerjasamas = [] }) {
        ...
        <MainLayout title="Beranda">
                            ...
                            <div className="lg:col-span-1">
                                ...
                                <div className="mt-8 bg-orange-600 rounded-2xl p-6 text-white text-center shadow-sm relative overflow-hidden group border border-orange-700">
                                    ...
                                    <div className="relative z-10">
                                        ...
                                        <p className="text-orange-200 text-sm mb-5 leading-relaxed">Butuh informasi lengkap seputar PMB atau akademik?</p>
            ...
            {kerjasamas && kerjasamas.length > 0 && (
                <section className="py-16 bg-gray-50 border-y border-gray-200">
                    <div className="container px-6 mx-auto lg:px-12 text-center">
                        <span className="text-sm font-bold tracking-wider text-orange-600 uppercase">Jaringan Kami</span>
                        <h2 className="mt-2 mb-10 text-2xl font-bold text-gray-800 md:text-3xl">Mitra Kerjasama STIKes Bogor Husada</h2>
                        
                        <div className="flex flex-wrap justify-center items-center gap-10 md:gap-16 opacity-70">
                            {kerjasamas.map((mitra, idx) => (
                                <div key={idx} className="w-24 h-24 md:w-32 md:h-32 flex items-center justify-center grayscale hover:grayscale-0 transition-all duration-500 hover:scale-110">
                                    <img 
                                        src={mitra.logo} 
                                        alt={mitra.name} 
                        ...
                        <div className="mt-10">
                            <Link href="/kerjasama" className="text-sm font-bold text-orange-600 hover:text-orange-800 transition-colors">
                    ...
                    <div className="container px-6 mx-auto lg:px-12 relative z-10">
                        <div className="mb-16 text-center max-w-2xl mx-auto">
                            ...
                            <p className="mt-4 text-gray-600 text-lg">
                                {testimoniSettings.description || 'Dengarkan cerita sukses dan pengalaman dari para alumni kami yang kini telah berkarya di berbagai instansi kesehatan.'}
                            </p>
                        </div>
                        ...
                        <div className="relative testimonial-slider-container">
                            ...
                            >
                                {alumnis.map((alumni, idx) => {
                                    ...
                                    const alumniFoto = alumni.foto || alumni.photo;
                                    // Berikan fallback pesan jika di DB alumni tidak ada kolom pesan
                                    const alumniPesan = alumni.pesan || alumni.testimoni || 'Belajar di STIKes Bogor Husada adalah keputusan terbaik saya. Dosennya profesional dan fasilitasnya sangat menunjang kompetensi saya di dunia kerja saat ini.';
                                            ...
                                            <div className="relative flex flex-col h-full p-8 transition-all duration-300 bg-white border border-gray-100 rounded-2xl hover:shadow-xl hover:-translate-y-2 group group-hover:bg-gray-50 shadow-sm">
                                                ...
                                                <div className="relative z-10 flex flex-col flex-1">
                                                    ...
                                                    <div className="flex items-center pt-6 mt-auto border-t border-gray-100">
                                                        {alumniFoto ? (
                                                            <img
                                                                src={alumniFoto.startsWith('http') || alumniFoto.startsWith('/') ? alumniFoto : `/storage/${alumniFoto}`}
                                                                alt={alumni.name}
                                                        ...
                                                        <div>
                                                            <h4 className="font-bold text-gray-900 group-hover:text-orange-900 transition-colors">{alumni.name}</h4>
                                                            <p className="text-sm font-medium text-orange-600">
                                                                {alumni.pekerjaan || alumni.instansi || alumni.program_studi || 'Alumni STIKes'}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
