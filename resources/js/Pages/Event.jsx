...
export default function Event() {
    return (
        <MainLayout title="Event & Agenda">
            <Head title="Event & Agenda" />
            <div className="pt-32 pb-24 bg-gray-50 min-h-screen">
                <div className="container px-6 mx-auto lg:px-12">
                    <div className="max-w-4xl mx-auto p-10 bg-white shadow-lg rounded-3xl text-center">
                        <i className="fas fa-calendar-alt text-6xl text-orange-500 mb-6"></i>
                        ...
                        <p className="text-gray-500 text-lg">Daftar event terbaru sedang dalam penyesuaian sistem.</p>
                    </div>
                </div>
            </div>
        </MainLayout>
