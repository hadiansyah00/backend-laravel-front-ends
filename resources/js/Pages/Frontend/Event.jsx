...
export default function Event({ events }) {
    ...
    // Ekstrak Jam:Menit dari format DateTime (karena Model pakai start_date)
    ...
    return (
        <MainLayout title="Agenda Kegiatan | STIKes Bogor Husada">
            {/* --- IMPROVED HERO SECTION (Smooth Wave) --- */}
                ...
                <div className="container relative z-10 px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="max-w-3xl pb-16 md:pb-24">
                        ...
                        <p className="max-w-2xl text-lg font-normal leading-relaxed text-gray-300 lg:text-xl">
                            Jangan lewatkan berbagai seminar, workshop, dan
                            kegiatan bermanfaat yang akan diselenggarakan oleh
                            STIKes Bogor Husada.
                        </p>
                    </div>
                </div>
            ...
            <section className="py-16 bg-white dark:bg-gray-950">
                <div className="container px-4 mx-auto max-w-7xl">
                    <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                        {eventList.length > 0 ? (
                            eventList.map((event) => {
                                // Cek properti image (bukan thumbnail)
                                ...
                                return (
                                    <div
                                        key={event.id}
                                        className="flex flex-col overflow-hidden transition-all duration-300 bg-white border border-gray-100 shadow-sm dark:bg-gray-900 rounded-3xl hover:shadow-xl dark:border-gray-800 group hover:-translate-y-2"
                                    >
                            ...
                            <div className="col-span-1 py-20 text-center border border-gray-100 md:col-span-2 lg:col-span-3 bg-gray-50 dark:bg-gray-900 rounded-3xl dark:border-gray-800">
                                <div className="flex items-center justify-center w-20 h-20 mx-auto mb-6 bg-gray-200 rounded-full dark:bg-gray-800">
                                    <svg
                                ...
                                <p className="max-w-sm mx-auto text-gray-500 dark:text-gray-400">
                                    Saat ini belum ada agenda kegiatan atau
                                    acara yang dijadwalkan dalam waktu dekat.
                                </p>
                            </div>
                        )}
                    </div>

                    {/* Pagination - ERROR .includes FIXED */}
